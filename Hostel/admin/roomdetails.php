...
<?php
  ...
  $sql="SELECT name,regno,email,phoneno,address,block,roomno FROM users WHERE gender='male';";
 ...
 ?>
  ...
  <thead>
    <tr>
      <th style="text-align: center;" colspan="7">Male</th>
    </tr>
    <tr>
      <th>Reg No</th>
      <th>Name</th>
...
<?php
  ...
  require_once('../dbConnect.php');
  $sql="SELECT name,regno,email,phoneno,address,block,roomno FROM users WHERE gender='female';";
    // $sql="SELECT regno,name,email,phoneno,block,roomno FROM users WHERE ";
  $query=mysqli_query($conn,$sql);
if(mysqli_num_rows($query)>0){
...
<thead>
  <tr>
    <th style="text-align: center;" colspan="7">female</th>
  </tr>
  <tr>
    <th>Reg No</th>
    <th>Name</th>
