...
<div class="wrapper">
	<div class="search_box">
		<input type="text" name="regno" id="regno" class="input_search" placeholder="Enter student regno" pattern="[A-Z]{2}[0-9]{4}">
...
<tbody>
  ...
  $sql="SELECT name,regno,email,phoneno,address,block,roomno FROM users WHERE regno='$regno';";
