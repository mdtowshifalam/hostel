...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
     ...
     if(isset($_POST['name']) && isset($_POST['regno']) && isset($_POST['email']) && isset($_POST['phoneno']) && isset($_POST['address'])  && isset($_POST['password']) && isset($_POST['confirmpassword']) && isset($_POST['gender']) ){
   ...
   if(!preg_match($nameregex, $name)){
     ...
     session_start();
   $sql="INSERT INTO `users`(`name`,`regno`,`email`,`phoneno`,`address`,`password`,`gender`,`block`)VALUES ('$name','$regno','$email','$phoneno','$address','$password','$gender','NULL')";
      ...
      <form action="registration.php"   method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your address" name="address" value="<?php echo "$address"; ?>" pattern="[A-Z a-z]*" required>
          </div>
          <div class="input-box">
