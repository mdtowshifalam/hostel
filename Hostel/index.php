...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\at1.png" alt="" class="NavLogo" onclick="rtohome()">
...
<div class="HeroContent">
  ...
  <p class="HeroP">Midnapore College(Autonomous)</p>
...
<div class="FooterWrap">
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="feed.php" class="FooterLink">Feedback</a>
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">Midnapore College(Autonomous) © 2024</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/MidnaporeCollege1873?mibextid=ZbWKwL" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://x.com/mcautonomous?s=20" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/midnaporecollege1873?igsh=MzRlODBiNWFlZA==" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://youtube.com/@drgopalchandrabera.princip178?si=1r-fpH8nnrmmHNi8" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
